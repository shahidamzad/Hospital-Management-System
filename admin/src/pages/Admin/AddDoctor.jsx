...
const AddDoctor = () => {
  ...
  const [docImag , setDocImg] = useState(false)
  const [name, setName] = useState('')
  const [email, setEmail] = useState('')
  const [password, setPassword] = useState('')
  const [experience,setExperience] = useState('1 Year')
  const [specaility, setSpeciality] = useState('General physician ')
      ...
      <div className='bg-white py-8 px-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll  '>
        <div className='flex items-center gap-4 mb-8 text-gray-500'>
          <label htmlFor='doc-img'>
            <img className='w-16 bg-gray-100 rounded-full cursor-pointer' src={docImag ? URL.createObjectURL(docImag)  :  assets.upload_area} alt="" />
          </label>
        ...
        <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
          ...
          <div className=' w-full lg:flex-1 flex flex-col gap-4'>
            <div className='flex-1 flex flex-col gap-1'>
              <p >Speciality</p>
              <select onChange={(e)=>setSpeciality(e.target.value)} value={specaility} className='border rounded px-3 py-2' name="" id="">
            ...
            <div className='flex-1 flex flex-col gap-1'>
              <p>Education</p>
              <input onChange={(e)=>setDegree(e.target.value)} value={degree} className='border rounded px-3 py-2' type="text" placeholder='Educations' required />
            </div>
        ...
        <button className='bg-primary px-10 mt-4 py-3 text-white rounded-full'>Add Doctor</button>
